...
public class RegisterServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		LogUtils.logPath(request);
		String username = Validations.escapeHtml(request.getParameter(WebAttributes.USER_NAME));
		String password = Validations.escapeHtml(request.getParameter(WebAttributes.PASSWORD));
		String password2 = Validations.escapeHtml(request.getParameter(WebAttributes.PASSWORD + "2"));
		String firstName = Validations.escapeHtml(request.getParameter("first_name"));
		String lastName = Validations.escapeHtml(request.getParameter("last_name"));
